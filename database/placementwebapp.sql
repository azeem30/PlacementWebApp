CREATE DATABASE IF NOT EXISTS `placementwebapp`
...
VALUES (
  ...
  (
    ...
    '1.44Logn Assume base of log is 2',
  ...
  (
    102,
    'An aeroplane covers a certain distance at a speed of 240 kmph in 5 hours. To cover the same distance in 1 and 2/3 hours, it must travel at a speed of:',
    '300 kmph',
    '300 kmph',
    '600 kmph',
    '720 kmph',
  ...
  (
    197,
    'If a = 0.1039, then the value of A group of students decided to collect as many paise from each member of group as is the number of members. If the total collection amounts to Rs. 59.29, the number of the member is the group is:',
    '57',
    '67',
    '77',
    '87',
...
VALUES (4, '5021145@it.fcrit.ac.in', 40),
  (3, '5021152@it.fcrit.ac.in', 40);
...
VALUES (
    'hS',
    '[{\"question_id\":22,\"question_text\":\"Which of the following is the most widely used external memory data structure?\",\"option_key\":\"option2\",\"selected_option\":\"Red-black tree\"},{\"question_id\":1,\"question_text\":\"What is a data structure?\",\"option_key\":\"option3\",\"selected_option\":\"A way to store and organize data\"},{\"question_id\":15,\"question_text\":\"Which of the following is false about a doubly linked list?\",\"option_key\":\"option2\",\"selected_option\":\"It requires more space than a singly linked list\"},{\"question_id\":25,\"question_text\":\"What is the advantage of a hash table as a data structure?\",\"option_key\":\"option4\",\"selected_option\":\"very efficient for less number of entries\"},{\"question_id\":27,\"question_text\":\"What would be the asymptotic time complexity to add a node at the end of singly linked list, if the pointer is initially pointing to the head of the list?\",\"option_key\":\"option2\",\"selected_option\":\"O(n)\"},{\"question_id\":21,\"question_text\":\"Which of the following is not the type of queue?\",\"option_key\":\"option3\",\"selected_option\":\"Single ended queue\"},{\"question_id\":19,\"question_text\":\"The prefix form of A-B/ (C * D ^ E) is?\",\"option_key\":\"option2\",\"selected_option\":\"-A/BC*^DE\"},{\"question_id\":23,\"question_text\":\"Which of the following data structure can provide efficient searching of the elements?\",\"option_key\":\"option2\",\"selected_option\":\"unordered lists\"},{\"question_id\":28,\"question_text\":\"What kind of linked list is best to answer questions like �What is the item at position n?�\",\"option_key\":\"option2\",\"selected_option\":\"Doubly linked list\"},{\"question_id\":13,\"question_text\":\"Which is the most appropriate data structure for reversing a word?\",\"option_key\":\"option2\",\"selected_option\":\"queue\"},{\"question_id\":29,\"question_text\":\"Which of the following is false about a circular linked list?\",\"option_key\":\"option3\",\"selected_option\":\"Time complexity for deleting the last node is O(n)\"},{\"question_id\":16,\"question_text\":\"What is the value of the postfix expression 6 3 2 4 + � *?\",\"option_key\":\"option2\",\"selected_option\":\"-18\"},{\"question_id\":8,\"question_text\":\"Which data structure is based on the Last In First Out (LIFO) principle?\",\"option_key\":\"option3\",\"selected_option\":\"Stack\"},{\"question_id\":30,\"question_text\":\"Space complexity for an adjacency list of an undirected graph having large values of V (vertices) and E (edges) is ___________\",\"option_key\":\"option2\",\"selected_option\":\"O(V*V)\"},{\"question_id\":17,\"question_text\":\"What data structure would you mostly likely see in non recursive implementation of a recursive algorithm?\",\"option_key\":\"option3\",\"selected_option\":\"tree\"},{\"question_id\":14,\"question_text\":\"In linked list each node contains a minimum of two fields. One field is data field to store the data second field is?\",\"option_key\":\"option2\",\"selected_option\":\"Pointer to integer\"},{\"question_id\":4,\"question_text\":\"The data structure required to check whether an expression contains a balanced parenthesis is?\",\"option_key\":\"option2\",\"selected_option\":\"Stack\"},{\"question_id\":3,\"question_text\":\"Which data structure is used for implementing recursion?\",\"option_key\":\"option3\",\"selected_option\":\"List\"},{\"question_id\":9,\"question_text\":\"What is a bit array?\",\"option_key\":\"option3\",\"selected_option\":\"Array in which elements are not present in continuous locations\"},{\"question_id\":6,\"question_text\":\"Which data structure is needed to convert infix notation to postfix notation?\",\"option_key\":\"option3\",\"selected_option\":\"Stack\"},{\"question_id\":10,\"question_text\":\"Which of the following data structures can be used for parentheses matching?\",\"option_key\":\"option4\",\"selected_option\":\"stack\"},{\"question_id\":24,\"question_text\":\"The optimal data structure used to solve Tower of Hanoi is _________\",\"option_key\":\"option4\",\"selected_option\":\"Stack\"},{\"question_id\":7,\"question_text\":\"Which of the following statement(s) about stack data structure is/are NOT correct?\",\"option_key\":\"option3\",\"selected_option\":\"Null link is present in the last node at the bottom of the stack\"},{\"question_id\":11,\"question_text\":\"What is the need for a circular queue?\",\"option_key\":\"option3\",\"selected_option\":\"effective usage of memory\"},{\"question_id\":18,\"question_text\":\"The data structure required for Breadth First Traversal on a graph is?\",\"option_key\":\"option2\",\"selected_option\":\"Stack\"},{\"question_id\":2,\"question_text\":\"What are the disadvantages of arrays?\",\"option_key\":\"option3\",\"selected_option\":\"Data structure like queue or stack cannot be implemented\"},{\"question_id\":20,\"question_text\":\"Which of the following tree data structures is not a balanced binary tree?\",\"option_key\":\"option3\",\"selected_option\":\"AVL tree\"},{\"question_id\":5,\"question_text\":\"Which of the following is not the application of stack?\",\"option_key\":\"option2\",\"selected_option\":\"Compiler Syntax Analyzer\"},{\"question_id\":12,\"question_text\":\"What is an AVL tree?\",\"option_key\":\"option2\",\"selected_option\":\"a tree which is balanced and is a height balanced tree\"},{\"question_id\":26,\"question_text\":\"What is a dequeue?\",\"option_key\":\"option3\",\"selected_option\":\"A queue with insert/delete defined for both front and rear ends of the queue\"}]',
    37,
    100,
    '36.62999999999999 %',
    '5021145',
...
;
-- Dump completed on 2023-10-11 21:26:03